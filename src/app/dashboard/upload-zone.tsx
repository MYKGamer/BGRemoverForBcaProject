...
export function UploadZone() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-8 px-4">
      {resultImage ? (
        <div className="bg-[#18181b]/80 border border-[#27272a] backdrop-blur-xl rounded-[2rem] p-6 md:p-10 text-center shadow-2xl space-y-8 animate-in zoom-in-95 duration-500">
          <div className="flex items-center justify-between px-2">
            <h3 className="text-xl font-bold text-white tracking-tight">AI Result Ready</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              ...
              className="w-full sm:w-auto bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-10 py-7 rounded-2xl flex items-center space-x-3 transition-all shadow-[0_10px_40px_-10px_rgba(37,99,235,0.5)] hover:shadow-[0_15px_50px_-10px_rgba(37,99,235,0.7)] text-lg font-bold group transform hover:-translate-y-1"
            >
            ...
            <Button 
              ...
              className="w-full sm:w-auto border-[#27272a] hover:bg-[#18181b] text-[#a1a1aa] hover:text-white px-8 py-7 rounded-2xl text-base font-semibold transition-all"
            >
              Remove Another
            </Button>
          </div>
        ...
        <div 
          {...getRootProps()} 
          className={`
            relative group border-2 border-dashed rounded-[2.5rem] p-8 md:p-20 text-center cursor-pointer transition-all duration-500 overflow-hidden
          ...
          <div className="flex flex-col items-center justify-center space-y-6 relative z-10">
            {isProcessing ? (
              <div className="relative">
                ...
                <div className="relative h-24 w-24 rounded-3xl bg-[#09090b] border border-[#2563eb]/30 flex items-center justify-center shadow-2xl">
                  <Loader2 className="h-10 w-10 text-[#2563eb] animate-spin" />
                </div>
              </div>
            ) : (
              <div className={`h-24 w-24 rounded-3xl flex items-center justify-center transition-all duration-500 shadow-2xl transform group-hover:scale-110 group-hover:rotate-3
                ${isDragActive ? 'bg-[#2563eb] rotate-3' : 'bg-[#09090b] border border-[#27272a] group-hover:border-[#2563eb]/40'}
              `}>
                <Upload className={`h-10 w-10 transition-colors duration-500
            ...
            <div className="space-y-2">
              ...
              <p className="text-[#a1a1aa] text-lg max-w-sm mx-auto">
                {isProcessing 
